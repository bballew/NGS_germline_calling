...
echo "intervalFile: '/DCEG/Projects/Exome/SequencingData/BED_FILES/seqcap_EZ_Exome_v3_v3utr_intersect_correct.intervals'" >> ${myOutPath}/TESTconfig.yaml
echo "bedFile: '/DCEG/Projects/Exome/SequencingData/BED_FILES/seqcap_EZ_Exome_v3_v3utr_intersect_correct.bed'" >> ${myOutPath}/TESTconfig.yaml
echo "clusterMode: 'qsub -q research.q -V -j y -o ${myOutPath}/logs/'" >> ${myOutPath}/TESTconfig.yaml
...
unset module
cmd="qsub -q research.q -V -j y -S /bin/sh -o ${myOutPath} /DCEG/CGF/Bioinformatics/Production/Bari/Germline_pipeline_v4_dev/germlineCallingV4/scripts/submit.sh ${myOutPath}/TESTconfig.yaml"
